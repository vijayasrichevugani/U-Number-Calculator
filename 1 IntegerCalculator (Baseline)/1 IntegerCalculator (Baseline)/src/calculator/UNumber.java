...
public class UNumber implements Comparable<UNumber> {
	...
	protected static int  numSignificant;
	...
	/**********
	 * The Square Root operation implements square root by using Newton-Raphson Method.
	 * 
	 * @param that	The Number  
	 */
	public static UNumber squareRoot(UNumber theValue){
		...
		do {
			...
			newGuess= new UNumber(theValue,numSignificant);
		...
		} while (digitsMatch < numSignificant);			// Determine if the old and the new guesses are "close enough"
		return newGuess;
