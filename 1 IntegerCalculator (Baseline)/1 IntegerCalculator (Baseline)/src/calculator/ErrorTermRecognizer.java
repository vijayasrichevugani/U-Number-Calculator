	...
	public static String checkErrorTerm(String input) {
		...
		while (running) {
			...
			case 8: 
				...
				// If the current character is equal to '.', it transitions to state 9
				if (currentChar == '.') {
					nextState = 9;
					break;
				}
		...
		case 0:
			...
			errorTermIndexofError = currentCharNdx;		// Copy the index of the current character;
			errorTermErrorMessage = "this must be a digit or a decimal";
			return "this must be a digit or a decimal";
		...
		case 6:
			...
			// move forward, the next characte	r must be a digit.
		...
		case 8:
			...
			// a digit or a plus or a minus character.
			errorTermErrorMessage = "This character be a decimal point "
					+ "character.\n";
			return errorTermErrorMessage + displayInput(input, currentCharNdx);
		...
		case 9:
			...
			// a digit or a plus or a minus character.
			errorTermErrorMessage = "This character be a decimal number "
					+ "character.\n";
			return errorTermErrorMessage + displayInput(input, currentCharNdx);
