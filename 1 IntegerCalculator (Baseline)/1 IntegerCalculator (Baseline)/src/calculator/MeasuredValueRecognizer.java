	...
	public static String checkMeasureValue(String input) {
		...
		while (running) {
			...
			case 5: 
				...
				// If the current character is + or -, it transitions to state 6
			...
			case 6: 
				// State 6 has one transition.  Each is addressed by an if statement.
			...
			case 7: 
				// State 7 has one transition.  Each is addressed by an if statement.
